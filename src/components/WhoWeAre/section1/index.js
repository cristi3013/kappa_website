		...
		<WhoWeAreFirstSectionWrapperCss>
			...
			<InfoBlockCss>
				...
				<p>
					...
					looking for a project to make our voices heard on the market. The first vote of
					confidence came with the first client, but there's only so much that can be done
					in a team of two. We had to grow fast, and we did.
				</p>

				<p>
					Bringing on board the right talent enabled us to take up more projects on web as
					well as software development. We found the right people overseas so we steadily
					became a fully-remote international team that embraces flexibility and the{' '}
				...
				<p>
					So what are we? An agency? A bunch of freelancers? Neither. We're a tight squad
					of passionate makers who work together and look out for each other.
				</p>
