	...
	return (
		<ThirdSectionWrapperCss>
			<ThirdSectionContainerCss>
				...
				<h2>Besides helping brands grow and impress, we've also built a few in-house projects over the past years. Have a look:</h2>	

				<BlockContainerCss >
					<TitleLink img={zeelo} imgWidth="350px">Zeelo</TitleLink>
				...
				<BlockContainerCss >
					<TitleLink img={lounge} imgWidth="350px">Lounge Works</TitleLink>
					<p>An idea that transforms restaurants and coffee shops all over London into ad-hoc working spaces. Individuals or companies can occupy areas in these venues and use them as temporary working spaces. </p>
					<p><span>HTML CSS JavaScript PHP <i>Expressions Engine</i> MySQL</span></p>
				</BlockContainerCss>

				<BlockContainerCss >
					<TitleLink img={honor} imgWidth="350px">Honor Cycles</TitleLink>
					<p>We built multiple systems for them to carry out their business more efficiently, such as an online service reservation widget and an online payment system.</p>
					<p><span>HTML CSS SaaS ReactJS PHP Laravel MySQL</span></p>
				</BlockContainerCss>

				<BlockContainerCss >
					<TitleLink img={cvlabs} imgWidth="350px">CV Labs</TitleLink>
				...
				<BlockContainerCss >
					<TitleLink img={create} imgWidth="350px">Create Live</TitleLink>
