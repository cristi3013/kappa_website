	...
	return (
		<ThirdSectionWrapperCss>
			<ThirdSectionContainerCss>
				...
				<BlockContainerCss >
					<TitleLink img={exampleGif}>Zeelo</TitleLink>
				...
				<BlockContainerCss >
					<TitleLink img={exampleGif}>Lounge Works</TitleLink>
				...
				<BlockContainerCss >
					<TitleLink img={exampleGif}>Honor Cycles</TitleLink>
				...
				<BlockContainerCss >
					<TitleLink img={exampleGif}>CV Labs</TitleLink>
				...
				<BlockContainerCss >
					<TitleLink img={exampleGif}>Create Live</TitleLink>
