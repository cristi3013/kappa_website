...
import { HeaderWrapperCss, DesktopMenuCss, MobileMenuCss, MobileToggleCss,GlobalStyle } from './index.css';
...
const Header = (props) => {
	...
	const lockScroll = ()=>{
		setScroll(window.pageYOffset); setShow(true);
	}
	...
	return (
		...
		<GlobalStyle show={show}/>
			...
			<MobileMenuCss show={show}>
				<img src={anim} alt=""/>
				<nav onClick={()=>{setScroll(0);window.scrollTo(0,0);setShow(false)}} >
					<Menu/>
				</nav>
			</MobileMenuCss>
		</HeaderWrapperCss>
