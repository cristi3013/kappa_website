                    ...
                    <div className="text">
                        <div className="info">
                            <h2 className="firstParagraph">
                                Our developers are our heroes: resourceful,
                                highly
                                <br></br>
                                skilled, energetic, and full of validated
                                potential.
                            </h2>
                            ...
                            <div className="numbers">
                                ...
                                <div className="developers">
                                    ...
                                    <p className="descDevs">
                                        developers were hurt
                                    </p>
                            ...
                            <h2 className="secondParagraph">
                                Our team dynamics are similar to a sports team:
                                a<br></br>{' '}
                                <span className="performanceStyled">
                                    performance-oriented collective
                                </span>{' '}
                                built on trust and<br></br> skill. We’re the
                                coach, you’re the player, and ahead<br></br> is
                                the goal.
                            </h2>
                        </div>
                    </div>
