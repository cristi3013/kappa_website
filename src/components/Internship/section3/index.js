...
import { InternshipThirdSectionWrapperCss, InfoBlockCss } from './index.css'
            ...
            <InfoBlockCss>
                <div className="container1">
                    <div className="box1 box">
                        <h4>
                            <span className="symbol">|</span> This is the Kappa
                            bootcamp
                    ...
                    <div className="box2 box">
                        <div className="gifContainer1">
                            ...
                            <img src={vrGoogles} className="vrGoogles" alt="" />
                            <img
                                src={vrController1}
                ...
                <div className="box5 box">
                    ...
                    <p className="paragraph4">
                        We believe in diversity as a catalyst for rapid personal
                        and professional growth. A young developer should
                        experience as many different challenges as possible in
                        order to acquire multiple skills during a shorter period
                        of time. You’ll be working on various real-life projects
                        that will intensely
