...
import { InternshipSection7WrapperCss, InfoBlockCss } from './index.css'
            ...
            <InfoBlockCss>
                ...
                <div className="text">
                    <p>
                        ...
                        <span className="w2">( NEW_DAY_AT_KAPPA )</span>
                    </p>
                    <p>
                        $
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>{' '}
                    ...
                    <p>
                        $
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>{' '}
                        <span className="w5">ask_for_resources</span>
                    ...
                    <p>
                        ...
                        <span className="w9">ask_for_resources</span>{' '}
                    ...
                    <p>
                        $
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>{' '}
                        <span className="w12">then </span> <span>&nbsp;</span>{' '}
                        <span> &#123;</span>
                    </p>
                    <p>
                        $
                    ...
                    <p>
                        ...
                        <span className="w19"> deadline is today</span>
                    </p>
                    <p>
                        $
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                    ...
                    <p>
                        ...
                        <span className="w40"> ask_for_review </span> =={' '}
                    ...
                    <p>
                        $
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        <span>&#125;</span> <span className="w45">else if</span>{' '}
                    ...
                    <p>
                        $
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                        <span className="w48">DELIVERED TASK SUCCESSFULLY</span>
                    </p>
                    <p>
                        $
                        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
