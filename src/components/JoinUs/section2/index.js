      ...
      <BlocksCss>
        ...
        >
          ...
          <ul>
            ...
            <li>
              PHP - Must be very comfortable with it and have strong knowledge
              of this language;
            </li>
            <li>Know at least one PHP MVC Framework;</li>
            <li>
              Ideally, this framework is Laravel (a big plus, two pluses
              actually, we really need a Laravel guy), or Symfony (just a small
              plus);
            </li>
            <li>
              Other frameworks like CakePHP, Zend, CodeIgniter are ok (but we’ll
              need to train you in Laravel most likely);
            </li>
            <li>Have knowledge of SQL, specifically MySQL or PostgreSQL;</li>
            <li>Have experience with Version Control (Git);</li>
            <li>
              Have some experience with Bash and Unix environments (generally we
          ...
          <ul>
            <li>
              Good knowledge of English language, as we are an international
              team;
            </li>
            <li>Supporting and troubleshooting existing client websites;</li>
            <li>Preparing technical documentation and test plans;</li>
            <li>
              Understanding the importance of maintainable code and coding
              standards;
            </li>
          ...
          <p>
            If needed, our team can provide further training to extend your
            skills and the knowledge of mentioned technologies.
          </p>
          <h4>| Benefits &lt;</h4>
          <ul>
